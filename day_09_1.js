...
const skip = (state, code) => {
    state.state = state.stack.pop();

    return state;
}

const garbage = (state, code) => {
    if (code === ">") {
        state.state = start;
    } else if (code === "!") {
...
const reducer = (state, code) => state.state(state, code)

const count = program => program
    .split("")
    .reduce(reducer, {
        score: 0,
        count: 0,
...
console.log(count("{{{},{},{{}}}}"), 6);
console.log(count("{<{},{},{{}}>}"), 1);
console.log(count("{<a>,<a>,<a>,<a>}"), 1);
console.log(count("{{<a>},{<a>},{<a>},{<a>}}"), 5);
...
console.log(count("{<a>,<a>,<a>,<a>}"), 1)
console.log(count("{{<ab>},{<ab>},{<ab>},{<ab>}}"), 9)
console.log(count("{{<!!>},{<!!>},{<!!>},{<!!>}}"), 9)
console.log(count("{{<a!>},{<a!>},{<a!>},{<ab>}}"), 3)
console.log(count(`
